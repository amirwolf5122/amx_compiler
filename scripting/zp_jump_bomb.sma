...
#define MAX_GRENADE    		1 		// Лимит гранат
...
#define MAX_GRENADE_MSG		"[BB] You bought a maximum of grenades"
...
public plugin_init()
{
	...
	//Extra Item
	register_concmd("zp_bomb_jumper_Amir_wolf", "zp_bomb_jumper")
}
